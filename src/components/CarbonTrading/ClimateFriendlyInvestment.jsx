    ...
    <div className="flex flex-col flex-wrap bg-[#F7F5F2]  justify-center text-center px-[30px] md:px-[60px] font-roboto lg:px-[80px] xl:px-[100px] py-8">
      <div className="flex flex-col pt-8 pb-4">
        ...
        <div className="text-[#3C3C3C] text-lg font-normal font-poppins leading-7">
          <p className="mt-4">
            In <a href="https://www.imf.org/en/Blogs/Articles/2022/06/30/greenhouse-emissions-rise-to-record-erasing-drop-during-pandemic#:~:text=The%20latest%20data%20from%20the,Dashboard%20provides%20a%20worrying%20picture.&text=Emissions%20of%20carbon%20dioxide%20and,mobility%20and%20hampered%20economic%20activity" className="text-[#BAB220] underline font-bold">2020</a>, global greenhouse gas emissions increased, but in the last
          ...
          <p className="mt-4">
            ...
            <a href="https://verra.org/" className="text-[#BAB220] underline font-bold ml-1">VERRA</a>- Verified Carbon Standard, they ensure that the efforts to
