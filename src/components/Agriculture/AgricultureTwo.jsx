    ...
    <section className="flex items-center bg-[#f7f5f2] flex-col-reverse lg:flex-row justify-center py-0 lg:py-16 px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
      ...
      <div className="lg:w-1/2 overflow-hidden rounded-lg shadow-2xl">
        <img
          src={img1}
          alt="Example"
          className="w-full h-[400px] transform hover:scale-105 transition-transform duration-300"
        />
      </div>

      {/* Right Column - Heading and Paragraph */}
      <div className="lg:w-1/2 px-8 md:px-10 lg:px-12 my-10 lg:my-0">
        <h2 className=" mb-3 tracking-normal text-[#316D69] font-bold text-4xl leading-7 font-montserrat">
          The Significance of{" "}
        ...
        <ul className="list-none list-inside text-[#3c3c3c] font-normal text-lg leading-7 mb-8 font-poppins">
          <li className=" mt-2">
