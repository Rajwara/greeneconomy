...
function AgricultureAssets() {
  return (
    <section className="flex items-center flex-col-reverse lg:flex-row justify-center mt-[100px] mb-[100px] px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
      {/* Left Column - Image */}
      ...
      <div className="lg:w-1/2 px-8 md:px-10 lg:px-12 my-10 lg:my-0">
        ...
        <p className="text-sm md:text-base lg:text-lg text-[#3c3c3c] font-normal leading-7 font-poppins">
        ...
        <p className="text-sm md:text-base lg:text-lg text-[#3c3c3c] font-normal leading-7 font-poppins mt-4">
          {" "}
