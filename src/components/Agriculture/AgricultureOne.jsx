    ...
    <div className="px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]  mt-[30px] md:mt-[50px] lg:mt-[50px] mb-[50px]">
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 lg:gap-x-[50px] ">
        <div className=" text-white  flex flex-col justify-center  ">
          ...
          <ul className=" list-inside gap-4 font-poppins  text-[#3c3c3c] font-normal text-sm md:text-base lg:text-lg leading-5 lg:leading-7 mb-2 md:mb-4 lg:mb-4 ml-4">
            <li className=" ">
          ...
          <p className="text-sm md:text-base lg:text-lg leading-5 lg:leading-7 text-[#3c3c3c] font-normal font-poppins  ">
