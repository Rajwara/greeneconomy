...
function AgricultureOne() {
  return (
    <section className="flex items-center flex-col gap-8 lg:flex-row justify-center mt-[0px] md:mt-[50px] lg:mt-[100px] mb-[50px]  px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
      ...
      <div className="lg:w-1/2  my-10 lg:my-0">
        ...
        <p className="text-sm md:text-base lg:text-lg text-[#3c3c3c] font-normal font-poppins leading-5 lg:leading-7 mb-4 md:mb-4 lg:mb-6">
        ...
        <ul className=" list-inside gap-4 font-poppins  text-[#3c3c3c] font-normal text-sm md:text-base lg:text-lg leading-5 lg:leading-7 mb-4 md:mb-4 lg:mb-6 ml-4">
          <li className="mt-2 ">
        ...
        <p className="text-sm md:text-base lg:text-lg leading-5 lg:leading-7 text-[#3c3c3c] font-normal font-poppins  mb-6">
