    ...
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8  flex-col md:flex-row px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[100px] mb-[50px]">
      <div className="flex flex-col  ">
        ...
        <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7  font-poppins font-normal ">
          ...
          tides. Tidal marshes are ecologically rich environments that serve as
          a habitat for a diverse range of biodiversity. They are significant
          shoreline stabilizers and carbon sinks, thus playing an important role
          in mitigating the effects of sea level rise. Based on the 2021
          Inventory, coastal wetlands within 48 states stored
          <a
        ...
        <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7  font-poppins font-normal mt-4 ">
          Despite their ecological importance, tidal marshes face a multitude of
          threats that endanger their sustainability. These include climate
