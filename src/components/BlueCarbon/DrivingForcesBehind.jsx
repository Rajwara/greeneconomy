  ...
  const DrivingForcesBehindCards = [
    {
      ...
      description: "Companies seeking alignment with the objectives of the Paris Agreement.",
    },
    {
      id: 2,
      image: bushland ,
    ...
    },
    {
      ...
      image: woodland ,
      title: "Time Gaps ",
      description: "Companies do not have sufficient time to eliminate their carbon emissions.  ",
    },
  ];
  return (
    <div className="   my-14 px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
      ...
      <div className="flex  text-center flex-wrap">
        {DrivingForcesBehindCards.map((items) => (
          <div className="w-[25%] " key={items.id}>
            <div className="flex flex-col ">
                <img src={items.image} alt=""  className="h-[200px] w-[200px] rounded-full mx-auto"/>
                <h4 className="font-montserrat text-xl font-bold text-[#bab220] mt-10">{items.title}</h4>
                <p className="text-lg font-poppins font-normal text-[#3c3c3c] leading-7 ">{items.description}</p>
