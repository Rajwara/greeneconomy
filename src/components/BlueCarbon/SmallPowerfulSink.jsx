...
const SmallPowerfulSink = () => {
  return (
    <div className="flex justify-center gap-8  flex-col md:flex-row px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[30px] md:mt-[50px] lg:mt-[100px] mb-[50px]">
      <div className="flex flex-col text-center items-center ">
        ...
        <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-5 lg:leading-7  font-poppins font-normal  lg:w-4/5">
          ...
          <a
            ...
            href="https://www.un.org/en/observances/seagrass-day#:~:text=Covering%20only%200.1%25%20of%20the,pollutants%2C%20reducing%20contamination%20in%20seafood"
          >
            {" "}
            0.1%
          </a>{" "}
