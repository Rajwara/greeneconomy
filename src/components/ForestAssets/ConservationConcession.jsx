      ...
      <div className="flex flex-col">
        ...
        {/* <div className="concessionmanagement">
          ...
          <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            ...
            logging concessions. In exchange for royalties and various fees,
            these firms gain the privilege of managing sizable forest tracts. In
            ...
            hectares were allocated to concessions. In most cases, the profits
            or government revenues generated from forest concessions were not
        ...
        <div className="conservationconcessions">
          ...
          <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            ...
            agreement, either national authorities or local resource custodians
            enter into a solemn pact, obliging themselves to safeguard natural
            ecosystems in return for a consistent and methodically structured
            compensation disbursed by dedicated conservationists or investors.
          </p>
          <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            In this context, a conservation concession can be envisioned akin to
            the conventional timber concessions. However, a remarkable
            distinction prevails. Rather than exploiting the concession area for
            commercial gain, the conservation investor assumes responsibility
        ...
        <div className="wwfheartofborneo">
          ...
          <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            ...
            which ranks as the third-largest island globally. It stretches
            across the shared highlands of Indonesia and Malaysia and extends
            into the adjacent lowlands and parts of Brunei. Borneo biodiversity
            ...
            of the world's total biodiversity and is home to 13 primate species,
            as well as over 15,000 plant species. The Heart of Borneo
        ...
        <div className="communityforestsandforestryassociations">
          ...
          <p className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            ...
            but also hold the potential to access a resource base of sufficient
            scale to support the issuance of forest-backed bonds as an
            alternative means of financing sustainable forest management (SFM).
            However, challenges are inherent to community forests, as evidenced
            in the study of the Mato Grosso region in Brazil.
          </p>
        </div>
        <div className="collaborativeventuresbetweenbusinessesandcommunities">
          ...
          <ul className="flex flex-col mt-4">
            <h6 className="uppercase text-lg text-[#316D69] font-bold	font-montserrat mb-2">
