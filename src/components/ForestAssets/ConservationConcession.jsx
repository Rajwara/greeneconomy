    ...
    <div className=" px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[50px] mb-[50px]">
      <div className="flex flex-col">
        <div className="conservationconcessions">
          <h2 className="text-[#316D69] text-2xl mb-8 md:text-3xl lg:text-4xl leading-10 mt-4  font-montserrat font-bold">
            Conservation
            <span className="text-[#bab220]"> Concessions </span>
          </h2>
          <div className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            <p className="">
              The Conservation Concession is an innovative approach that
              reconciles the imperative need for resource preservation and
              development. Within the framework of this innovative conservation
              agreement, either national authorities or local resource
              custodians enter into a solemn pact, obliging themselves to
              safeguard natural ecosystems in return for a consistent and
            ...
            <p className=" mt-4  ">
              ...
              for commercial gain, the conservation investor assumes
              responsibility for the preservation of the forest.
            </p>
          </div>
        </div>
        <div className="wwfheartofborneo">
          <h2 className="text-[#316D69] text-2xl mb-6 md:text-3xl lg:text-4xl leading-10 mt-4 tracking-normal font-montserrat font-bold">
          ...
          <div className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            <p className="">
              ...
              square kilometers, equivalent in size to the entire United
              Kingdom. This region covers about one-third of the vast island of
              Borneo, which ranks as the third-largest island globally. It
              stretches across the shared highlands of Indonesia and Malaysia
              and extends into the adjacent lowlands and parts of Brunei. Borneo
              biodiversity is quite extraordinary as it serves as the origin of
              <a
              ...
              of the world's total biodiversity and is home to 13 primate
              species, as well as over 15,000 plant species. The Heart of Borneo
            ...
            <p className=" mt-4  ">
              ...
              , Conservation International entered into a 30-year agreement with
              the Government of Guyana to establish a conservation concession
              protecting 80,000 hectares of pristine forest. It serves as a
              valuable interim solution allowing the support of vital ecosystems
              until more permanent arrangements can be established, such as
              national parks and protected areas. In this context, conservation
              concessions provide:
            </p>
          </div>
          <div className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal  ml-6">
            <p className=" mt-4  ">
        ...
        <div className="communityforestsandforestryassociations">
          ...
          <div className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            <p className="">
              ...
              rights and legal titles to communities and indigenous groups with
              historical ties to these lands. The extent of this transformation
              in forest ownership is illustrated by the fact that, since 1985,
            ...
            <p className=" mt-4  ">
              ...
              bonds as an alternative means of financing sustainable forest
              management (SFM). However, challenges are inherent to community
              forests, as evidenced in the study of the Mato Grosso region in
              Brazil.
            </p>
          </div>
        </div>
        <div className="collaborativeventuresbetweenbusinessesandcommunities">
          ...
          <div className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-7 mt-4 font-poppins font-normal ">
            <p className=" ">
              ...
              with individual growers or cooperatives. These relationships vary
              depending on how risks, costs, and profits are distributed between
              the involved parties. In certain instances, particularly in
              plantation-based scenarios, forestry companies play a significant
          ...
          <ul className="flex flex-col mt-4">
            <h6 className="uppercase text-sm md:text-base lg:text-lg text-[#316D69] font-bold leading-9	font-montserrat mb-2">
              The primary advantages for companies typically include:
            </h6>
            <ul className="flex flex-col mt-4  text-[#3c3c3c] text-sm md:text-base list-disc lg:text-lg leading-7 font-poppins font-normal">
              <li className="ml-6">
                Indirect cost savings, as they are not required to purchase
                land.
              </li>
              <li className="ml-6">
                The opportunity to gain access to resources on land that might
                not otherwise be available for outright purchase.
              </li>
            </ul>
          </ul>
        </div>
...
export default ConservationConcession;
