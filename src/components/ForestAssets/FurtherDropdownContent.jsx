  ...
  return (
    <div className="px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[30px]  lg:mt-[50px] mb-[30px] xl:mb-[50px]">
      <Accordion open={open === 1}>
        <AccordionHeader
          className="text-xl md:text-2xl xl:text-3xl text-[#316D69] font-montserrat font-bold leading-7 xl:leading-9"
      ...
      <Accordion open={open === 3}>
        ...
        <AccordionBody>
          ...
          <p className="text-[#3c3c3c] text-sm md:text-base xl:text-lg leading-5 xl:leading-7 mt-4  font-poppins font-normal">
          ...
          <ul className="flex flex-col text-[#3c3c3c] list-disc text-sm md:text-base xl:text-lg leading-5 xl:leading-7 ml-6 mt-4  font-poppins font-normal">
