    ...
    <div>
      <div className=" grid grid-cols-1  lg:grid-cols-2 gap-14 mx-auto mt-[30px] md:mt-[50px] lg:mt-[50px]  px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
        <div className="flex flex-col flex-wrap">
          ...
          <h2 className=" text-[#BAB220]  text-2xl md:text-3xl lg:text-4xl mb-2 md:mb-4 lg:mb-6 font-montserrat leading-7 lg:leading-10 font-bold">
        ...
        <div className="flex  items-center justify-center">
          <img src={WMImg2} alt="" className="rounded-lg h-full w-full " />
        </div>
      </div>
    </div>
  );
