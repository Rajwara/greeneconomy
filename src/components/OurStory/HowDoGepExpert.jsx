...
const HowDoGepExpert = () => {
  return (
    <div className="px-[30px] bg-[#f7f5f2]  md:px-[60px] lg:px-[80px] xl:px-[100px] mx-auto text-center pt-[30px] lg:pt-[50px] pb-[30px] xl:pb-[50px]">
      <h2 className="text-2xl md:text-3xl xl:text-4xl leading-7 xl:leading-10 mb-2 md:mb-4 lg:mb-6 font-montserrat font-bold text-[#316D69]">
        How Do GEP Experts Help You Combat Climate Change?
      </h2>
      <div className="text-sm md:text-base xl:text-lg xl:w-8/12 mx-auto font-poppins leading-5 xl:leading-7 text-[#3c3c3c] font-normal">
        <p className="">
        ...
        <p className="mt-2  xl:mt-4">
          ...
          businesses to opt for less polluting technologies, and persuades them
          in doing so. GEP experts help you reduce carbon emissions, calculate
          your carbon footprint, resulting in the reduction of global greenhouse
          gas emissions.
        </p>
      </div>
    </div>
