  ...
  return (
    <div className="px-[30px] bg-[#f7f5f2] py-10 md:px-[60px] lg:px-[80px] xl:px-[100px] mx-auto text-center mt-20">
      ...
      <p className="text-lg w-8/12 mx-auto font-poppins text-[#3c3c3c] font-normal">
        ...
        the amount of greenhouse gasses, particularly CO2, that could be emitted
        by each industrial sector which is where CO2 sensor technology monitors
        emissions. Each year, industries are given individual quotas of CO2
        emissions, and our carbon credit trading platforms help them throughout
        the process. It is through carbon trading that the government wants the
        businesses to opt for less polluting technologies, and persuades them in
        doing so. GEP experts help you reduce carbon emissions, calculate your
