    ...
    <div className="flex flex-row  lg:items-center px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] md:mt-[50px] lg:mt-[50px] mt-[30px] mb-[50px]">
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
        <div className="text-sm md:text-base lg:text-lg font-normal mt-4 font-poppins leading-5 lg:leading-7 text-[#3c3c3c]">
          ...
          <div className="mb-2 md:mb-4 lg:mb-6 text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-5 lg:leading-7 font-normal font-poppins">
            <p className=" ">
          ...
          <ul className="text-[#3c3c3c] text-sm md:text-base lg:text-lg leading-5 lg:leading-7 font-normal font-poppins list-disc">
            <h6 className="uppercase text-sm md:text-base lg:text-lg text-[#316D69] font-bold leading-7 lg:leading-9	font-montserrat mb-2 lg:mb-4">
