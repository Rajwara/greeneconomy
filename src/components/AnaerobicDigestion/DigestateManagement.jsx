...
import Digestate from "../../../src/images/2.jpg";
  ...
  return (
    <div className="  flex justify-center gap-8 flex-col md:flex-row px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] p-5 md:p-20">
      <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 ">
        <div>
          <h1 className="text-[#BAB220] text-xl mb-8 md:text-2xl lg:text-3xl leading-7 tracking-normal font-montserrat font-bold">
            Digestate
      ...
      <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 p-4">
        <img src={Digestate} alt="" className="w-full h-[400px]" />
      </div>
    </div>
  );
};
