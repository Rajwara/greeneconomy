...
function AnaerobicDigestionForIndustry() {
  return (
    <div className=" bg-[#f7f5f2] flex justify-center gap-8  flex-col md:flex-row px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] pt-[30px]  lg:pt-[50px] mt-[30px] pb-[30px] xl:pb-[50px]">
      ...
      <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 ">
        ...
        <img
          src={indurtry}
          alt=""
          className="w-full h-[200px]  lg:h-[200px] xl:h-[300px] rounded-lg mt-4"
        />
      </div>
      ...
      <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 lg:p-4">
        <div>
          <h6 className="uppercase text-sm md:text-base xl:text-lg text-[#316D69] font-bold leading-7 xl:leading-9	font-montserrat mb-2 md:mb-2 xl:mb-4">
            For Private Sectors:
          </h6>
          <p className="text-[#3c3c3c] text-sm md:text-base xl:text-lg leading-5 xl:leading-7 font-poppins font-normal">
        ...
        <div>
          <h6 className="uppercase text-sm md:text-base xl:text-lg text-[#316D69] leading-7 xl:leading-9 font-bold	font-montserrat mb-2 md:mb-2 xl:mb-4 mt-4">
            For Public Sectors:
          </h6>
          <p className="text-[#3c3c3c] text-sm md:text-base xl:text-lg leading-5 xl:leading-7 font-poppins font-normal">
        ...
        <p className="text-[#3c3c3c] text-sm md:text-base xl:text-lg leading-5 xl:leading-7 tracking-normal font-poppins font-normal mt-2 xl:mt-4">
