...
const PlantIntelligentConsortiums = () => {
  return (
    <div className="flex flex-col text-center mt-6 md:mt-[50px] lg:mt-[50px] px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] items-center">
      ...
      <p className="text-sm md:text-base lg:text-lg   text-[#3c3c3c] font-normal font-poppins leading-5 lg:leading-7">
