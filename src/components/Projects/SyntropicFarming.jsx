...
const SyntropicFarming = () => {
  return (
    <div className=" flex flex-col text-center  dark:bg-white overflow-hidden  px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]  lg:flex lg:items-center">
      <div className=" pt-[30px] md:pt-[50px] lg:pt-[50px] pb-[50px] text-center  ">
        <div className="flex flex-col items-center text-center">
          <h2 className=" text-2xl md:text-3xl font-bold text-center leading-7  mb-2 md:mb-4 lg:mb-6   lg:leading-10 lg:text-4xl font-montserrat text-[#316D69] dark:text-[#316D69]">
            <span className="text-[#bab220]">A. </span>
            Syntropic Farming
          </h2>
          <span className="border-2 border-[#3c3c3c] w-[20%] mt-4 "> </span>
        </div>
        <div className="flex flex-col text-sm md:text-base lg:text-lg  text-center justify-center items-center mt-2 md:mt-4 lg:mt-6 text-[#3c3c3c] font-normal font-poppins leading-5 lg:leading-7">
          ...
          <p className="mt-2  lg:mt-4  lg:w-9/12">
