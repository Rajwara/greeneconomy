...
const InnerCard = () => {
  ...
  return (
    <div className="  px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[30px]  lg:mt-[50px] pb-[30px] xl:pb-[50px]">
      <div className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-8 ">
        {data.map((item) => (
          ...
          >
            ...
            <p className=" mt-2 lg:mt-4 text-[#3c3c3c] font-poppins text-sm md:text-base xl:text-lg leading-5 xl:leading-7 font-normal">
              {item.description}
            </p>
          </div>
        ))}
