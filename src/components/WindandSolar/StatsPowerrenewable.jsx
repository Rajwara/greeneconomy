      ...
      <div className="relative">
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 gap-8 lg:items-center">
          <div className="ml-auto lg:col-start-2 ">
            <h2 className="mt-2 text-2xl md:text-3xl lg:text-4xl font-bold leading-10 font-montserrat text-[#3c3c3c] dark:text-white sm:text-3xl sm:leading-9">
              The Power of Renewables
            </h2>
            <p className="mt-4 text-sm md:text-base lg:text-lg leading-7 font-normal font-poppins text-[#3c3c3c] dark:text-gray-300">
              ...
              <ul className="gap-6   ">
                <li className="mt-4 ">
                  <div className="flex">
                    ...
                    <span className="ml-4 text-sm md:text-base lg:text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                      <p>
