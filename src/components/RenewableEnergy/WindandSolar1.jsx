  ...
  return (
    <div className="flex flex-col justify-center text-center items-center  mx-auto px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[100px] pb-10">
      <div className="text-center flex flex-col items-center">
        <h2 className="text-[#316D69] mb-8 leading-9 tracking-normal font-montserrat font-bold text-4xl ">
          Wind and
          <span className="text-[#bab220]"> Solar</span>
        </h2>
        <div className="text-[14px] md:text-[16px] lg:text-lg font-normal  text-[#3c3c3c] font-poppins leading-7  w-4/5">
          <p className="mt-0">
