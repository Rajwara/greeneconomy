    ...
    <div className="relative">
      <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:items-center">
        <div className="ml-auto lg:col-start-2 ">
          ...
          Nature-based solutions represent more than just a concept, they are grounded in compelling statistics. Here’s how numbers confirm the importance of these nature-based assets:
          ...
          <ul className="gap-6   ">
            <li className="mt-4 ">
              <div className="flex">
                ...
                Sustainable forestry practices can offset nearly 16% of domestic carbon dioxide emissions by storing 866 million metric tons of CO2 per year. 
                </span>
              </div>
            </li>
            <li className="mt-2 ">
              <div className="flex">
                ...
                <span className="ml-4 text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                Forests cover 31% of the Earth’s land area, containing more than 80% of the world's terrestrial biodiversity that stores more carbon than the entire atmosphere. 
                </span>
              </div>
            </li>
            <li className="mt-2 ">
              <div className="flex">
                ...
                Sustainable forestry can generate jobs for at least 33 million people. 
                </span>
              </div>
            </li>
          ...
          <ul className="gap-6  ">
            <li className="mt-4 ">
              <div className="flex">
                ...
                <span className="ml-4 text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                Mangroves and coastal wetlands annually sequester carbon at a rate ten times greater than mature tropical forests.
                </span>
              </div>
            </li>
            <li className="mt-2 ">
              <div className="flex">
                ...
                <span className="ml-4 text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                Though seagrass covers 0.1% of the world's seafloor, but stores 11% of ocean’s buried carbon. 
          ...
          <ul className="gap-6   ">
            <li className="mt-4 ">
              <div className="flex">
                ...
                <span className="ml-4 text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                In 2018, emissions from agriculture, and associated land use comprised 17% of the global greenhouse gas emissions. Smart agriculture can reduce these emissions to a significant amount. 
                </span>
              </div>
            </li>
            <li className="mt-2 ">
              <div className="flex">
                ...
                <span className="ml-4 text-lg font-normal font-poppins leading-7 text-[#3c3c3c] dark:text-gray-200">
                According to WEF, smart agricultural practices have the potential to increase crop yields by 300 metric million tonnes by 2030, while saving $100 billion for farmers in reduced costs.
