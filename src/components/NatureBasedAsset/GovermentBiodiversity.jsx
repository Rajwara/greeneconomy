...
const GovermentBiodiversity = () => {
  return (
    <div className="px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] pb-10 mt-[100px]">
      <h2 className="text-2xl ma:text-3xl lg:text-4xl mb-6 font-montserrat leading-10  font-bold text-[#316D69]">
        How Governments Are Dealing With Climate Change and Biodiversity?
      </h2>
      <div className=" text-sm md:text-base lg:text-lg font-normal font-poppins leading-7 text-[#3c3c3c]">
        <p className="mt-4 ">
