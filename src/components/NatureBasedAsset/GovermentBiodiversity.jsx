...
const GovermentBiodiversity = () => {
  return (
    ...
    <p className="mt-4 ">Climate change and biodiversity are part of an interlinked triple planetary crisis; the UN is therefore, tackling with them together through:</p>
