...
const GovermentBiodiversity = () => {
  return (
    <div className="px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] pb-10 mt-[50px] md:mt-[80px] lg:mt-[100px]">
      <h2 className="text-2xl ma:text-3xl lg:text-4xl mb-4 md:mb-6 lg:mb-8 font-montserrat leading-7 lg:leading-10  font-bold text-[#316D69]">
