          ...
          <div className="flex flex-wrap  lg:justify-between">
            <div className="w-full  lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-sm md:text-base lg:text-lg  font-semibold text-[#BAB220] text-primary font-montserrat  leading-7">
                  Feel free to...
                </span>
                <h2 className="mb-6 text-2xl md:text-3xl lg:text-4xl leading-10 font-bold uppercase text-[#316D69] text-dark   font-montserrat ">
                  CONTACT US
                </h2>
                <p className="text-sm md:text-base lg:text-lg  leading-7 mb-9 text-[#3c3c3c] font-poppins font-normal">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      ...
                      height={24}
                      viewBox="0 0 24 24"
                      className="fill-current text-[#316D69]"
                    >
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-base md:text-lg lg:text-xl font-bold text-[#316D69] font-montserrat tracking-normal leading-9">
                      Our Location
                    </h4>
                    <p className="text-sm md:text-base lg:text-lg  leading-7 text-[#3c3c3c] font-poppins font-normal">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-base md:text-lg lg:text-xl font-bold text-[#316D69] font-montserrat  leading-9">
                      Phone Number
                    </h4>
                    <p className="text-sm md:text-base lg:text-lg  leading-7 text-[#3c3c3c] font-poppins font-normal">
                      (+62)81 414 257 9980
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-l-0 border-r-0 border-t-0 border-[#316D69] w-full resize-none border-b-2 leading-7 font-montserrat py-3 px-[14px] text-sm md:text-base lg:text-lg  text-[#3c3c3c] outline-none focus:border-primary focus-visible:shadow-none"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-b-2 border-l-0 border-r-0 border-t-0 border-[#316D69] leading-7 font-montserrat w-full py-3 px-[14px] text-sm md:text-base lg:text-lg  text-body-color outline-none "
        />
      </div>
    </>
  );
