...
function ServicesHome() {
  return (
    <div>
      <div className="mx-auto  md:text-center lg:text-center mt-[30px] md:mt-[50px] text-start   lg:mt-[50px] px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
        <h6 className="uppercase text-sm md:text-base lg:text-lg text-[#D3CA28] font-bold leading-7 lg:leading-9	font-montserrat	">
          Services
        </h6>
        <h2 className="text-2xl md:text-3xl lg:text-4xl xs:text-start font-montserrat font-bold mb-2 md:mb-4 lg:mb-6 leading-7 lg:leading-10 text-[#316D69]">
