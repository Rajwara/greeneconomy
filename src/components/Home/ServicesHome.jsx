  ...
  return (
    <div>
      <div className="mx-auto  text-center mt-20 px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
        <h6 className="uppercase text-sm md:text-base lg:text-lg text-[#D3CA28] font-bold leading-9	font-montserrat	">
          Services
        </h6>
        <h2 className="text-2xl md:text-3xl lg:text-4xl xs:text-start font-montserrat font-bold leading-10 text-[#316D69]">
          Towards a Sustainable and Smarter Future
        </h2>
        <div className="lg:w-8/12 xs:text-start mx-auto text-sm md:text-base lg:text-lg font-poppins leading-7 mt-10 text-[#3c3c3c]">
          <p className=" ">
