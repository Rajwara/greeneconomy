...
const OurPartner = () => {
  return (
    <div className="bg-[#EFEDD1] pb-[50px] pt-10 mt-10 px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px]">
      <div className=" mx-auto font-roboto text-center  ">
        <div>
          <h2 className="text-2xl mb-2 md:mb-4 lg:mb-6 md:text-3xl lg:text-4xl leading-7 lg:leading-10  font-montserrat font-bold text-[#316D69]">
            Our Partners
          </h2>
