...
const GreenEconomyCanHelp = () => {
  ...
  return (
    <div className="flex justify-center gap-8 flex-col px-[30px] md:px-[60px] lg:px-[80px] xl:px-[100px] mt-[30px] lg:mt-[50px] mb-[30px] xl:mb-[50px]">
      ...
      <div className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {data.map((item) => (
          <div className="cards-text rounded-lg" key={item.id}>
            ...
            <p className="text-[#f7f5f2] bg-[#316D69] p-2 text-sm md:text-base xl:text-lg leading-5 xl:leading-7 font-normal font-poppins relative bottom-[80px]">
              {item.description}
            </p>
          </div>
        ))}
